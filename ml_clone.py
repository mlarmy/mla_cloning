...
'''
this is an open source program by ᴍʟ ᴀʀᴍʏ
...
╚═╝     ╚═╝╚══════╝    ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝     ╚═╝   ╚═╝   
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %sᴍʟ ᴀʀᴍʏ                    %s"%(Z,B,M,Z))
	print("%s║%s  Github   : https://github.com/mlarmy  %s"%(Z,B,Z))
	print("%s║%s  YouTube  : ᴍʟ ᴀʀᴍʏ       %s"%(Z,B,Z))
	print("%s║%s  Version  : %s2.0                          %s"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	xox('            %s》%s》%s》%sᴍʟ ᴀʀᴍʏ%s《%s《%s《'%(M,H,B,H,B,H,M))
	print("")
